...
const (
	...
	WorkerStatus_ALLOCATED                 WorkerStatus = 2
	WorkerStatus_BUSY_RENDER_SETUP         WorkerStatus = 3
	WorkerStatus_BUSY_RENDERING            WorkerStatus = 4
	WorkerStatus_BUSY_OTHER                WorkerStatus = 5
	WorkerStatus_OFFLINE                   WorkerStatus = 6
)
...
const (
	Endianness_UNKNOWN_ENDIAN Endianness = 0
...
type QueryWorkerStatusResponse struct {
	...
	AvailableCores   uint32                 `protobuf:"varint,2,opt,name=available_cores,json=availableCores,proto3" json:"available_cores,omitempty"`
	...
	FreeMemoryBytes  uint64                 `protobuf:"varint,4,opt,name=free_memory_bytes,json=freeMemoryBytes,proto3" json:"free_memory_bytes,omitempty"`
	Status           WorkerStatus           `protobuf:"varint,5,opt,name=status,proto3,enum=discovery.WorkerStatus" json:"status,omitempty"`
	Endianness       Endianness             `protobuf:"varint,6,opt,name=endianness,proto3,enum=discovery.Endianness" json:"endianness,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
