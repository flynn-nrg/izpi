...
type Camera struct {
	...
	Exposure      float32                `protobuf:"fixed32,11,opt,name=exposure,proto3" json:"exposure,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Camera) GetExposure() float32 {
	if x != nil {
		return x.Exposure
	}
	return 0
...
const file_transport_proto_rawDesc = "" +
	...
	"\x18white_balance_properties\"\xed\x02\n" +
	"\x06Camera\x12+\n" +
	...
	"\rwhite_balance\x18\n" +
	" \x01(\v2\x17.transport.WhiteBalanceR\fwhiteBalance\x12\x1a\n" +
	"\bexposure\x18\v \x01(\x02R\bexposure\"\xd5\x03\n" +
	"\aTexture\x12\x12\n" +
