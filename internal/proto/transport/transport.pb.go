...
var file_transport_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_transport_proto_goTypes = []any{
	...
	(*SpectralCheckerTexture)(nil),    // 19: transport.SpectralCheckerTexture
	(*Material)(nil),                  // 20: transport.Material
	(*LambertMaterial)(nil),           // 21: transport.LambertMaterial
	(*DielectricMaterial)(nil),        // 22: transport.DielectricMaterial
	(*DiffuseLightMaterial)(nil),      // 23: transport.DiffuseLightMaterial
	(*IsotropicMaterial)(nil),         // 24: transport.IsotropicMaterial
	(*MetalMaterial)(nil),             // 25: transport.MetalMaterial
	(*PBRMaterial)(nil),               // 26: transport.PBRMaterial
	(*Triangle)(nil),                  // 27: transport.Triangle
	(*Sphere)(nil),                    // 28: transport.Sphere
	(*SceneObjects)(nil),              // 29: transport.SceneObjects
	(*Scene)(nil),                     // 30: transport.Scene
	(*GetSceneRequest)(nil),           // 31: transport.GetSceneRequest
	(*StreamTextureFileRequest)(nil),  // 32: transport.StreamTextureFileRequest
	(*StreamTextureFileResponse)(nil), // 33: transport.StreamTextureFileResponse
	(*StreamTrianglesRequest)(nil),    // 34: transport.StreamTrianglesRequest
	(*StreamTrianglesResponse)(nil),   // 35: transport.StreamTrianglesResponse
	nil,                               // 36: transport.Scene.MaterialsEntry
	nil,                               // 37: transport.Scene.ImageTexturesEntry
	nil,                               // 38: transport.Scene.DisplacementMapsEntry
}
var file_transport_proto_depIdxs = []int32{
	...
	19, // 10: transport.Texture.spectral_checker:type_name -> transport.SpectralCheckerTexture
	...
	15, // 17: transport.SpectralCheckerTexture.odd:type_name -> transport.SpectralConstantTexture
	15, // 18: transport.SpectralCheckerTexture.even:type_name -> transport.SpectralConstantTexture
	2,  // 19: transport.Material.type:type_name -> transport.MaterialType
	22, // 20: transport.Material.dielectric:type_name -> transport.DielectricMaterial
	23, // 21: transport.Material.diffuselight:type_name -> transport.DiffuseLightMaterial
	24, // 22: transport.Material.isotropic:type_name -> transport.IsotropicMaterial
	21, // 23: transport.Material.lambert:type_name -> transport.LambertMaterial
	25, // 24: transport.Material.metal:type_name -> transport.MetalMaterial
	26, // 25: transport.Material.pbr:type_name -> transport.PBRMaterial
	10, // 26: transport.LambertMaterial.albedo:type_name -> transport.Texture
	15, // 27: transport.LambertMaterial.spectral_albedo:type_name -> transport.SpectralConstantTexture
	15, // 28: transport.DielectricMaterial.spectral_refidx:type_name -> transport.SpectralConstantTexture
	7,  // 29: transport.DielectricMaterial.absorption_coeff:type_name -> transport.Vec3
	15, // 30: transport.DielectricMaterial.spectral_absorption_coeff:type_name -> transport.SpectralConstantTexture
	10, // 31: transport.DiffuseLightMaterial.emit:type_name -> transport.Texture
	15, // 32: transport.DiffuseLightMaterial.spectral_emit:type_name -> transport.SpectralConstantTexture
	10, // 33: transport.IsotropicMaterial.albedo:type_name -> transport.Texture
	15, // 34: transport.IsotropicMaterial.spectral_albedo:type_name -> transport.SpectralConstantTexture
	7,  // 35: transport.MetalMaterial.albedo:type_name -> transport.Vec3
	10, // 36: transport.PBRMaterial.albedo:type_name -> transport.Texture
	10, // 37: transport.PBRMaterial.roughness:type_name -> transport.Texture
	10, // 38: transport.PBRMaterial.metalness:type_name -> transport.Texture
	10, // 39: transport.PBRMaterial.normal_map:type_name -> transport.Texture
	10, // 40: transport.PBRMaterial.sss:type_name -> transport.Texture
	7,  // 41: transport.Triangle.vertex0:type_name -> transport.Vec3
	7,  // 42: transport.Triangle.vertex1:type_name -> transport.Vec3
	7,  // 43: transport.Triangle.vertex2:type_name -> transport.Vec3
	8,  // 44: transport.Triangle.uv0:type_name -> transport.Vec2
	8,  // 45: transport.Triangle.uv1:type_name -> transport.Vec2
	8,  // 46: transport.Triangle.uv2:type_name -> transport.Vec2
	7,  // 47: transport.Triangle.normal0:type_name -> transport.Vec3
	7,  // 48: transport.Triangle.normal1:type_name -> transport.Vec3
	7,  // 49: transport.Triangle.normal2:type_name -> transport.Vec3
	4,  // 50: transport.Triangle.operator:type_name -> transport.GeometryOperator
	6,  // 51: transport.Triangle.displace:type_name -> transport.DisplaceOperator
	7,  // 52: transport.Sphere.center:type_name -> transport.Vec3
	27, // 53: transport.SceneObjects.triangles:type_name -> transport.Triangle
	28, // 54: transport.SceneObjects.spheres:type_name -> transport.Sphere
	3,  // 55: transport.Scene.colour_representation:type_name -> transport.ColourRepresentation
	9,  // 56: transport.Scene.camera:type_name -> transport.Camera
	36, // 57: transport.Scene.materials:type_name -> transport.Scene.MaterialsEntry
	37, // 58: transport.Scene.image_textures:type_name -> transport.Scene.ImageTexturesEntry
	38, // 59: transport.Scene.displacement_maps:type_name -> transport.Scene.DisplacementMapsEntry
	29, // 60: transport.Scene.objects:type_name -> transport.SceneObjects
	17, // 61: transport.Scene.spectral_background:type_name -> transport.TabulatedSpectralConstant
	...
	30, // 69: transport.SceneTransportService.GetScene:output_type -> transport.Scene
	33, // 70: transport.SceneTransportService.StreamTextureFile:output_type -> transport.StreamTextureFileResponse
	35, // 71: transport.SceneTransportService.StreamTriangles:output_type -> transport.StreamTrianglesResponse
