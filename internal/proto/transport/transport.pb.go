...
type DielectricMaterial_AbsorptionCoeff struct {
	AbsorptionCoeff *Vec3 `protobuf:"bytes,3,opt,name=absorption_coeff,json=absorptionCoeff,proto3,oneof"`
}

type DielectricMaterial_SpectralAbsorptionCoeff struct {
	SpectralAbsorptionCoeff *SpectralConstantTexture `protobuf:"bytes,4,opt,name=spectral_absorption_coeff,json=spectralAbsorptionCoeff,proto3,oneof"`
}
